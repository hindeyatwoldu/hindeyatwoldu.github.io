...
const experiences = [
  ...
  {
    org: "CARE Ethiopia",
    role: "Emergency Livestock Livelihoods Team Leader",
    years: "2021 – 2023",
    highlights: [
      "Supported over 120,000 households with emergency food security and resilience measures",
      "Enabled 45,000 farmers and pastoralists to access veterinary services through voucher-based systems",
      "Improved income for 30,000 smallholder farmers through value chain development",
      "Coordinated early warning systems across 20 woredas, reaching 1.2 million people",
      "Facilitated rapid mobilization of assistance to 250,000 households",
    ],
  },
  {
    org: "Relief Society of Tigray (REST)",
    role: "Senior Livelihoods and Animal Health Officer",
    years: "2020 – 2021",
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Coordinated livestock health programs, vaccination campaigns, and fisheries development",
    ],
  },
  {
    org: "Government of Ethiopia",
    role: "Livestock & Fisheries Health and Quarantine Coordinator",
    years: "December 2010 – January 2014",
    highlights: [
      "Directed livestock health services, including treatment, vaccination, and disease outbreak response",
      "Managed quarantine stations, ensuring proper inspection and certification of livestock for trade and movement",
      "Promoted climate-smart agriculture practices and improved forage development for livestock productivity",
      "Supported genetic improvement initiatives and fishery livelihood programs to diversify household income",
      "Conducted household-level assessments to identify livestock-related vulnerabilities and design targeted interventions",
    ],
  },
];
